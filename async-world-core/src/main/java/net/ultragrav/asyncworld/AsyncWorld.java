...
public abstract class AsyncWorld {
    ...
    public abstract void syncForAllInRegion(CuboidRegion region, BiConsumer<IntVector3D, Integer> action, boolean multiThread);
     ...
     */
    public abstract void syncForAllInRegion(CuboidRegion region, AsyncWorldTriConsumer<IntVector3D, Integer, TagCompound> action, boolean multiThread);
     ...
     */
    public abstract void asyncForAllInRegion(CuboidRegion region, AsyncWorldQuadConsumer<IntVector3D, Integer, TagCompound, Integer> action, boolean multiThread);

    /**
     * If anyone reading this at any point DOES NOT know what a Tile Entity is, here is an explanation <br/>
    ...
    public void setBlock(IntVector3D vec, int id, byte data) {
        setBlock(vec.getX(), vec.getY(), vec.getZ(), id, data);
    }
}
