...
public class BigMath {
    ...
    // numbers greater than 10^MAX_DIGITS_10 or e^MAX_DIGITS_EXP are considered
     ...
     *
     * @param exponent Any finite value (infinite or Nan throws
     *                 IllegalArgumentException)
     * @return The value of e (base of the natural logarithms) raised to the given
     * exponent, as in <tt>Math.exp()</tt>
     */
